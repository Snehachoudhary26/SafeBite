...
export default function Footer({ setActiveTab }) {
  return (
    <footer className="border-t border-slate-800 bg-slateDark-950 text-slate-400 text-xs py-10 sm:py-14">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="space-y-3">
            <div className="flex items-center gap-2 text-white font-bold text-base">
              <Shield className="w-5 h-5 text-cobalt-400" />
        ...
        <div className="border-t border-slate-800/80 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px]">
          ...
          <a href="https://github.com/Snehachoudhary26/SafeBite" target="_blank" rel="noreferrer" className="hover:text-white font-mono">
            GitHub: Snehachoudhary26/SafeBite
          </a>
        </div>
      </div>
    </footer>
