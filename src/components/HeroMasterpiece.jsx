...
import { ArrowRight, FlaskConical, AlertTriangle, ShieldCheck, Flame, Droplet, Eye, Radio, Sparkles } from 'lucide-react';

export default function HeroMasterpiece({ setActiveTab }) {
  return (
    <div className="relative overflow-hidden pt-8 pb-16 lg:pt-12 lg:pb-24 border-b border-slate-200/80 dark:border-slate-800/80">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        {/* Main Grid: Left Typography + Center Food Scientist + Right 4 Stacked HUD Cards */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          
          {/* 1. Left Column: Exact Headline & CTAs from Image 1 */}
          <div className="lg:col-span-5 space-y-6 text-left">
            ...
            <h1 className="text-4xl sm:text-5xl xl:text-6xl font-black text-slate-900 dark:text-white tracking-tight leading-[1.08]">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 pt-2">
              ...
              <button
                ...
                className="px-7 py-3.5 rounded-xl bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-800 dark:text-slate-200 font-bold text-sm border border-slate-300 dark:border-slate-700 flex items-center justify-center gap-2 transition-all shadow-sm"
              >
          ...
          {/* 2. Center-Right Column: Food Scientist in Lab Coat Testing Food + 4 Stacked HUD Cards */}
          <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
            
            {/* The Food Scientist Real Food Testing Photograph (matching Image 1) */}
            <div className="md:col-span-7 relative rounded-3xl overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-700/80 bg-slate-900 aspect-[4/5] sm:aspect-square md:aspect-[4/5]">
              ...
              <div className="absolute bottom-4 left-4 right-4 p-3 rounded-2xl bg-slate-950/80 backdrop-blur-md border border-slate-700/80 text-white text-xs">
                <span className="text-[10px] text-cyan-400 font-mono font-bold block">REAL FOOD OPTICAL ASSAY</span>
                <span className="font-bold">Street Noodles & Reused Cooking Oil Inspection</span>
              </div>
            </div>

            {/* The 4 Stacked Live Diagnostic HUD Cards (matching Image 1 exactly) */}
            <div className="md:col-span-5 space-y-3">
              
              {/* CARD 1: Oil Quality Analysis */}
              <div className="p-3.5 rounded-2xl hud-card dark:hud-card hud-card-light shadow-xl text-left space-y-2">
                ...
                <div>
                  <div className="text-[11px] text-slate-600 dark:text-slate-300">TPC (Total Polar Compounds)</div>
                ...
                <div className="grid grid-cols-3 gap-1 pt-1 border-t border-slate-200 dark:border-slate-800 text-[10px]">
                  <div>
                    ...
                    <span className="font-bold text-slate-800 dark:text-white">38.7 cP</span>
                  </div>
                  <div>
                    <span className="text-slate-400 block text-[8px]">Smoke Point</span>
                    <span className="font-bold text-slate-800 dark:text-white">176°C</span>
                  </div>
                  <div>
                    <span className="text-slate-400 block text-[8px]">Dark Index</span>
                    <span className="font-bold text-slate-800 dark:text-white">0.87</span>
                  </div>
                </div>
              </div>

              {/* CARD 2: Dye Detection with Rainbow Thermal Heatmap */}
              <div className="p-3 rounded-2xl hud-card dark:hud-card hud-card-light shadow-xl text-left flex items-center justify-between gap-2">
                <div>
                  ...
                  <div className="text-[10px] text-slate-500 dark:text-slate-400">Rhodamine B</div>
                  <div className="text-xs font-black text-rose-500">DETECTED</div>
                  <div className="text-[9px] text-slate-400">Confidence: 98.7%</div>
                </div>

                {/* Thermal Rainbow Box from Image 1 */}
                <div className="w-14 h-12 rounded-xl thermal-grad-box border border-slate-700 shadow-inner shrink-0 flex items-center justify-center">
              ...
              <div className="p-3 rounded-2xl bg-rose-950/80 dark:bg-rose-950/80 bg-rose-50 border border-rose-500/40 text-left flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-[10px] text-rose-700 dark:text-rose-200">Unsafe for Consumption</div>
                </div>
              </div>

              {/* CARD 4: Live Kafka Telemetry from Image 1 */}
              <div className="p-3 rounded-2xl hud-card dark:hud-card hud-card-light shadow-xl text-left space-y-1.5">
                ...
                <div className="grid grid-cols-3 gap-1 text-[10px] font-mono pt-1">
                  <div>
                    ...
                    <span className="font-bold text-slate-800 dark:text-white">8,392</span>
                  </div>
                  <div>
                    <span className="text-slate-400 block text-[8px]">Latency</span>
                    <span className="font-bold text-slate-800 dark:text-white">120 ms</span>
                  </div>
                  <div>
                    <span className="text-slate-400 block text-[8px]">Sources</span>
                    <span className="font-bold text-slate-800 dark:text-white">98</span>
                  </div>
                </div>
              </div>
